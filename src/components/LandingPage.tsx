      ...
      <section className="min-h-screen flex flex-col justify-center px-4 sm:px-6 py-16 sm:py-20 max-w-4xl mx-auto">
        ...
        >
          ...
          <a
            ...
            className="w-full sm:w-auto min-h-12 px-8 py-4 rounded-full border border-white/20 text-white font-bold text-lg hover:bg-white/5 transition-colors text-center"
          >
            Module ansehen
          </a>
        </motion.div>
